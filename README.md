...
[Chitter Challenge](https://github.com/SophLewDev/chitter-challenge)  | Social medial site inspired by Twitter. Users are able to sign up, log in, log out, create and view 'peeps' (aka tweet). | 2 days | Ruby, PostgreSQL, Sinatra, Heroku
